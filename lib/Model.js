...
/*
		...
		*/
		...
		, init: function( options ){
			...
			Object.defineProperty( this, "__changed", { value: [], enumerable: false, configurable: false } );
			Object.defineProperty( this, "__values", { value: {}, enumerable: true, configurable: false } );
			Object.defineProperty( this, "__columns", { value: {}, enumerable: false, configurable: false } );
			Object.defineProperty( this, "__primary", { value: {}, enumerable: false, configurable: false } );
			Object.defineProperty( this, "__isFromDB", { value: false, enumerable: false, configurable: false } );
			...
			if ( options.$db ) 		Object.defineProperty( this, "__db", { value: options.$db, enumerable: false, configurable: false } );
			if ( options.$dbName ) 	Object.defineProperty( this, "__databaseName", { value: options.$dbName, enumerable: false, configurable: false } );
			if ( options.$model ) 	Object.defineProperty( this, "__model", { value: options.$model, enumerable: false, configurable: false } );
		}
			...
			if ( this.__columns ){
				...
				while( i-- ){
					( function( columnName ){
						...
						var getter = function(){ return this.__values[ columnName ]; }.bind( this );
